...
void initHashTable()
{
    ...
    // 插入read、write函数
    insertFunction("read", Int, NULL, 0, NULL, NULL, NULL, NULL);
    VariableType* type = (VariableType*)calloc(1, sizeof(VariableType));
    type[0] = Int;
    char(* name)[32] = (char(*)[32])calloc(1, sizeof(char) * 32);
    strncpy(name[0], "val_to_print", 32);
    insertFunction("write", Int, NULL, 1, NULL, type, NULL, name);
}
