...
CompSt : LC DefList StmtList RC {
    ...
    | LC DefList error StmtList RC {error_pos = @3.first_line;yyerror("eSyntax Error");}
...
Stmt : Exp SEMI {
    ...
    | Exp error SEMI {error_pos = @2.first_line;yyerror("eSyntax Error");}
